...
--Loop principal con una Lista de prioridad. La prioridad la tiene la Tup con el menor tiempo cambiante (Notificacion,Tiempo cambiante, Cantidad de errores)
